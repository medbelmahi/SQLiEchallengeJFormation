 ...
 */
@Controller
public class CollaborateurHabilitationDeleteAction extends SqliActionSupport {
	...
	public String execute() throws Exception {
		try {
			...
			habilitationMetier.deleteHabilitationFromCollaborateur(idCollaborateur, idHabilitation);
			
			setSessionActionMessageText(getText("collaborateur.habilitation.delete.success"));
