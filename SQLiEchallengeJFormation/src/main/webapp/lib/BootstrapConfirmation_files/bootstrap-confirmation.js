 ...
 /* CONFIRMATION PLUGIN DEFINITION
	* ======================= */
	...
	$.fn.confirmation.defaults = $.extend({} , $.fn.tooltip.defaults, {
		...
		, href   : '#'
		, title: 'Vous étes sur?'
		, template: '<div class="popover" style="width:200px;" >' +
				'<div class="arrow"></div>' +
				'<h3 class="popover-title"></h3>' +
				'<div class="popover-content text-center">' +
				'<div class="btn-group" style="width:100%;" >' +
				'<a class="btn btn-danger" href="" target="" style="width:50%;" ></a>' +
				'<a class="btn btn-info" style="width:50%;" data-dismiss="confirmation"></a>' +
				'</div>' +
				'</div>' +
				'</div>'
