...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>Administration : Gestion des habilitations</title>
	...
	<section>
	    ...
	    <div class="main-content" >
	        ...
	        <div class="page-heading">
	            <h3>
	                Administration <small>Gestion des habilitations</small>
	            </h3>
	        </div>
	        <!-- page heading end-->
	        <!--body wrapper start-->
	        <div class="wrapper">
		        ...
		        <div class="row"><!-- present working link Start-->
		            <div class="col-md-12">
		                ...
		                <ul class="breadcrumb panel">
		                    ...
		                    <li class="active">Gestion des habilitation</li>
		                </ul>
		                <!--breadcrumbs end -->
		            </div>
		        ...
		        <!-- Message action end-->
		      	...
		      	<!-- Data table des habilitations Start -->
					<s:include value="include/data_table_habilitations.jsp"></s:include>
				<!-- Data table des habilitations End -->
				
				<!-- Ajout habilitation Modal Form -->
					<s:include value="include/ajout_habilitation_modal.jsp"></s:include>
				<!-- End Ajout habilitation Modal Form -->
...
<%-- 	<!--multi-select-->
 ...
 --%>
	...
	<%-- <!-- javascript of habilitation_list page Begin -->
		<s:include value="include/javascript_habilitation_list.jsp"></s:include>
	<!-- javascript of habilitation_list page End --> --%>
