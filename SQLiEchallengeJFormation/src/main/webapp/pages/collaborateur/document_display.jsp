									...
									<div class="panel-body" style="padding: 0px;">
										<div class="profile-pic text-center">
											<img alt="" src='<s:url namespace="/" action='download'>
																	<s:param name="file"><s:property value="inscription.sessionFormation.formateur.urlPhotoUtilisateur" />
																	</s:param></s:url>'>
							...
							<tbody aria-relevant="all" aria-live="polite" role="alert">
								<s:iterator value="documents">
										<tr class="gradeA odd">
											...
											<td class="text-center" style="width-min : 60px">
												
												<ul style="list-style: none; width: 20px;" class="navbar-nav nav-options">
