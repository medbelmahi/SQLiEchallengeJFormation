...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>Formateur: Gestion des documents</title>
	...
	<section>
	    ...
	    <div class="main-content" >
	        ...
	        <div class="page-heading">
	            <h3>
	                Formateur<small>Gestion des documents</small>
	            </h3>
	        </div>
	        <!-- page heading end-->
	        <!--body wrapper start-->
	        <div class="wrapper">
		        ...
		        <!-- Message action end-->
		      	...
		      	<!-- Data table des sessions Start -->
					<s:include value="include/data_table_documents.jsp"></s:include>
				<!-- Data table des sessions End -->
				
				<!-- Ajout Session Modal Form -->
					<s:include value="include/ajout_document_modal.jsp"></s:include>
